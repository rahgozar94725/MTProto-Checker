...
* **لیست داخلی پروکسی:** با یک کلیک روی **«بارگذاری لیست»** فهرستی که هر شب از ۱۷ منبع عمومی بازساخته می‌شود بارگذاری می‌شود — اگر شبکه اجازه دهد نسخهٔ تازه، و اگر مسدود بود نسخهٔ پخته‌شده در خود باینری. می‌توانید منبع اضافه یا خاموش کنید، منابع بر اساس تعداد پروکسی سالمی که داده‌اند امتیاز می‌گیرند، و دریافت لیست می‌تواند از یک پروکسی SOCKS5 عبور کند.
...
3.  **یا بارگذاری لیست داخلی:** روی **«بارگذاری لیست»** بزنید تا فهرست شبانه‌ای که از ۱۷ منبع عمومی ساخته می‌شود بیاید — اول نسخهٔ شبکه، و اگر مسدود بود نسخهٔ داخل باینری. برای افزودن نشانی خودتان یا خاموش کردن منابع **«منابع لیست»** را باز کنید، و اگر خود این لیست‌ها فیلترند **«پروکسی SOCKS5 (اختیاری)»** را.
4.  **شروع:** روی دکمه **«شروع بررسی»** کلیک کنید.
5.  **صبر کنید:** ابتدا فرمت‌های نامعتبر حذف می‌شوند، سپس همهٔ پروکسی‌ها هم‌زمان بررسی می‌شوند و نتیجهٔ هرکدام همان لحظه می‌رسد. چهار کاشی بالای کادر ورودی — پیشرفت، سالم، بهترین پینگ، ناموفق/ردشده — همان‌طور که پیش می‌رود به‌روز می‌شوند.
6.  **برداشت نتایج:** پروکسی‌های سالم در جدول نتایج، سریع‌ترین اول، ظاهر می‌شوند — یک ردیف را کپی کنید، **«کپی کردن لیست سالم»** را بزنید یا خروجی TXT/JSON بگیرید.
